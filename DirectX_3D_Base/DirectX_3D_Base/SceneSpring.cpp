...
void SceneSpring::Init()
{
	...
	pTexManager->AddTexture(PATH_TEX_EFFECT_SPRING, EFFECT_SPRING_TEX_NUM);	// 種(春)
	...
	pModelManager->AddModel(PATH_MODEL_SPRING_GOAL, SPRING_GOAL_MODEL_NUM);	//ゴール時
	// ステージブロック
...
#pragma region	---背景(0
		...
		Draw_BG0->SetTexture(pTexManager->GetTexture(BG_A0_TEX_NUM));		//	テクスチャ
...
#pragma region	---背景(1
		...
		Draw_BG1->SetTexture(pTexManager->GetTexture(BG_A1_TEX_NUM));		//	テクスチャ
...
#pragma region	---背景(2
		...
		Draw_BG2->SetTexture(pTexManager->GetTexture(BG_A2_TEX_NUM));		//	テクスチャ
...
#pragma region	---背景(3
		...
		Draw_BG3->SetTexture(pTexManager->GetTexture(BG_A3_TEX_NUM));		//	テクスチャ
...
#pragma region	---背景(4
		...
		Draw_BG4->SetTexture(pTexManager->GetTexture(BG_A4_TEX_NUM));		//	テクスチャ
...
#pragma region	---背景(5
		...
		Draw_BG5->SetTexture(pTexManager->GetTexture(BG_A5_TEX_NUM));		//	テクスチャ
...
#pragma region	---背景(6
		...
		Draw_BG6->SetTexture(pTexManager->GetTexture(BG_A6_TEX_NUM));		//	テクスチャ
...
#pragma region	---背景(7
		...
		Draw_BG7->SetTexture(pTexManager->GetTexture(BG_A7_TEX_NUM));		//	テクスチャ
...
#pragma endregion
	...
	{
		DrawSLogo->SetTexture(pTexManager->GetTexture(SPRING_1_TEX_NUM));	// テクスチャ設定
	}
	else if (SceneGame::GetInstance()->GetSeason() == SPRING_2)
	{
		DrawSLogo->SetTexture(pTexManager->GetTexture(SPRING_2_TEX_NUM));	// テクスチャ設定
	}
